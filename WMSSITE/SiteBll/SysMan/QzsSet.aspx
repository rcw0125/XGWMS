<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QzsSet.aspx.cs" Inherits="SiteBll_SysMan_QzsSet" %>
...
<head runat="server">
    ...
    <script language="javascript" src="../../JavaScript/QZSSet.js" type="text/javascript"></script>
</head>
<body>
    ...
    <TABLE class="fixColStyle" id="Table1" height="28" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD vAlign="middle" align="center" width="60%" style="height: 29px"><font style="FONT-SIZE: 12px; COLOR: #072d52; FONT-FAMILY: 宋体">签证室设置</font></TD>
					<TD vAlign="middle" align="center" width="2%" style="height: 29px"><IMG src="../../images/icon/compartcenter.gif" align="textTop">
					</TD>
        ...
        <asp:GridView ID="grvdoor" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="qzs_no" HeaderText="签证室编号" SortExpression="WGDH" />
                <asp:BoundField DataField="qzs_name" HeaderText="签证室名称" SortExpression="scxbm" />
	...
	<br/>&nbsp;&nbsp;签证室编号：<input id="txtdoorno" type="text" runat="server" /><br/>
	&nbsp;&nbsp;签证室名称：<input type="text" id="txtdoorname" runat="server"/><br />
    &nbsp;&nbsp;IP&nbsp;&nbsp;地&nbsp;&nbsp;址：<input type="text" id="txtip" runat="server"/>    <br />
	...
	<br/>&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;签证室：<asp:DropDownList ID="ddlmg"
            runat="server" OnSelectedIndexChanged="ddlmg_SelectedIndexChanged" onchange="javascript:sethidvalue();">
        </asp:DropDownList>
