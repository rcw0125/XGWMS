<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fyd_QrSearch.aspx.cs" Inherits="SiteBll_FormMan_Fyd_QrSearch" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" src="../../JavaScript/FormFYDQRSearch.js" type="text/javascript"></script>
    ...
    <form id="form1" runat="server" method="post">
		<TABLE class="fixColStyle" id="Table1" height="28" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD vAlign="middle" align="center" width="60%"><font style="FONT-SIZE: 12px; COLOR: #072d52; FONT-FAMILY: 宋体"><asp:literal id="m_labTitle" runat="server" Text="发运单监控查询"></asp:literal></font></TD>
					<TD vAlign="middle" align="center" width="2%"><IMG src="../../images/icon/compartcenter.gif" align="textTop">
					</TD>
      ...
      <input name="hidden" type="hidden" id="hidCPH" runat="server" /></td>
        ...
        <input name="hidden" type="hidden" id="hidKHH" runat="server" /></td>
                ...
                <td>
                    <asp:TextBox ID="txtCMKH" runat="server" Width="95%"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td style="height: 25px"><asp:TextBox ID="MakeEndTime" runat="server" Width="85%" Enabled="False"></asp:TextBox><img src="../../Images/icon/calendar.gif" onclick="calendar(MakeEndTime);" style="cursor: hand" /></td>
                                <td style="height: 25px">
            ...
            <tr>
             ...
             <tr>
                                <td>
                                    <input name="checkbox2" type="checkbox" id="chkChuanShu" onclick="GetChuanShu();" runat="server" checked="checked" disabled="disabled"/>运输</td>
                                <td align="left">
                                    <asp:DropDownList ID="drpChuanShu" runat="server" Width="95%" Enabled="False"> 
                                        <asp:ListItem Value="0" >请选择</asp:ListItem>
                                        <asp:ListItem Value="1" Selected="True">汽车发运</asp:ListItem>
...
</table><input id="hidFYDHitem" type="hidden" runat="server" />
                        <input id="hidStatus" type="hidden" runat="server" />
                        <input id="hidyslb" type="hidden" runat="server" />
                        <input id="hidItem" type="hidden" runat="server"/>
                        <input id="Hidconfig" type="hidden" runat="server"/>
                        <input id="hidQuery" runat="server" type="hidden" />
    <div id="tblPList" style="height:150px; display:none;">
    <iframe id="frmList" width="98%" height="220px"></iframe>
    </div>
    </form>
</body>
</html>
