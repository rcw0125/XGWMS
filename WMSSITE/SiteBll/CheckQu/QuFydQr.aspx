<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuFydQr.aspx.cs" Inherits="SiteBll_CheckQu_QuFydQr" %>
...
<head runat="server">
    ...
    <script language="javascript" src="../../JavaScript/FormFYDQR.js" type="text/javascript"></script>
</head>
<body leftMargin="0" topMargin="0" onload="Init();">
    <form id="form1" runat="server" method="post">
		<TABLE class="fixColStyle" id="Table1" height="28" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD vAlign="middle" align="center" width="60%"><font style="FONT-SIZE: 12px; COLOR: #072d52; FONT-FAMILY: 宋体"><asp:literal id="m_labTitle" runat="server" Text="签证装车确认"></asp:literal></font></TD>
					<TD vAlign="middle" align="center" width="2%"><IMG src="../../images/icon/compartcenter.gif" align="textTop">
					</TD>
					...
					<TD align="center" width="10%"><!--<label style="FONT-SIZE: 12px; COLOR: #072d52; FONT-FAMILY: 宋体">列表配置</label>--><IMG id="btnconfig" style="CURSOR: hand; display:none;" onclick="Addconfig();" alt="关闭" src="../../images/icon/collapse.gif"
							align="textTop" border="0">
					</TD>
  ...
  <uc2:PageControl id="PageControl1" runat="server">
                ...
                <asp:GridView ID="grvFYD" runat="server" AutoGenerateColumns="False"  AllowSorting="True" Width="100%" OnSorting="grvFYD_Sorting" OnRowCreated="grvFYD_RowCreated">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SJSL" HeaderText="实际数量" SortExpression="SJSL" Visible="False" >
                            <ItemStyle Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </asp:BoundField>
  ...
  <tr>
    ...
    <td width="10%" style="height: 18px"><asp:Label ID="sjsl" runat="server" Text="0" Visible="False"></asp:Label></td>
...
<!--  
			...
			-->
				...
				<tr>
				    <td colspan="2">
                        &nbsp;<img src="../../Images/icon/print.gif" onclick="displayDivP('divPrint');" id="imgPrint" style="display:none" />
                        &nbsp;&nbsp;&nbsp;
                        <img  ID="imgBtnFei" Height="20px" src="../../Images/icon/qzqr.gif"
                     Width="66px" onclick="javascript:zhqr();" />
                        &nbsp;
                        &nbsp;<asp:ImageButton ID="btn_camer" runat="server" ImageUrl="../../Images/icon/cappic.gif" OnClick="btn_camer_Click" Height="20px" Width="66px" />
                        &nbsp;&nbsp;
                        <asp:ImageButton ID="btnCancle" runat="server" ImageUrl="../../Images/icon/cancelwc.gif" OnClick="btnCancle_Click" Visible="False"/>
                        &nbsp;
                        &nbsp; &nbsp;
                        <img src="../../Images/icon/che.gif" id="che" onclick="displayDiv('popbox');" style="cursor:hand; display:none "/>
