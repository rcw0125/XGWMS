<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintPYRK.aspx.cs" Inherits="SiteBll_PDMan_PrintPYRK" %>
...
<object ID='WebBrowser' WIDTH=0 HEIGHT=0 CLASSID='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'VIEWASTEXT></object>
    <form id="form1" runat="server">
          <table style="width: 664px; height: 46px">
              <tr>
                  <td colspan="3" style="height: 43px" align="center">
                      <span style="font-size: 18pt">盘盈入库单</span></td>
              </tr>
              <tr>
          ...
          <asp:GridView ID="grdPYRK" runat="server" AutoGenerateColumns="False" BorderColor="Black" Width="664px">
              <Columns>
