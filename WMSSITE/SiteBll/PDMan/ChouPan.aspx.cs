...
public partial class SiteBll_PDMan_ChouPan : AccPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //this.txtPDDH.Attributes.Add("onblur", "CheckPDDH('2')");
            this.btnPrintPDD.Attributes.Add("onclick", "OpenPrintXP()");
    ...
    private void BindPddDetailGrid(string PDDH)
    {
        try
        {
            DataSet dsPDDDetail = PDParam.getXPDDetailDS(PDDH);
            this.grdInfo.DataSource = dsPDDDetail;
            this.grdInfo.DataBind();
        }
        catch
        {
            this.PrintfError("绑定明细列表时发生错误，请重试");
            return;
        }
    }
    #endregion
    ...
    private void BindHW2(string PDDH)
    {
        try
        {
            DataSet dsHW2 = PDParam.getHW2XPDS(PDDH);
    ...
    protected void btnSavePDD_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (State == "AddPDD")
            {
                string result = PDParam.AddXPD(this.txtYSDH.Text.Trim(), this.txtPDDH.Text.Trim(), this.hidCKID.Value.Trim(), this.txtPDRQ.Text.Trim(), this.txtZDRQ.Text.Trim(), this.txtZDRY.Text.Trim(), "卷", "吨", HW2);
                if (result == "success")
                {
            ...
            if (State == "ModifyPDD")
            {
                ...
                string result = PDParam.ModifyXPD(this.txtPDDH.Text.Trim(), this.hidCKID.Value.Trim(), HW2, "卷", "吨");
                if (result == "success")
                {
                    this.PrintfError("保存成功");
                }
            ...
            this.hidState.Value = "";
            DataSet ds = PDParam.getXPDDetailDS(this.txtPDDH.Text.Trim());
        ...
        {
            this.PrintfError("保存过程中出现错误，请重试");
            return;
        }
    }
    #endregion
    ...
    protected void btnGoOK_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                DataSet ds = PDParam.LookXPddDetail(this.txtPDDH.Text.Trim(), "卷", "吨", this.hidCKID.Value.Trim(), HW2);
                this.grdInfo.DataSource = ds;
                this.grdInfo.DataBind();
            }
        }
    ...
    protected void btnGoRight_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            this.PrintfError("移动货位时出现错误，请确保选中了货位");
            return;
        }
    }
    #endregion
    ...
    protected void btnDeletePDD_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            {
                this.WriteClientJava("DeleteXPD('" + PDDH + "');");
            }
        }
        catch
        {
            this.PrintfError("删除盘点单时发生错误，请重试");
            return;
        }
    }
    #endregion
    ...
    protected void btnShenhePDD_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    string result = PDParam.shenheXPD(YSDH, PDDH, this.CUSER.UserID, "卷", "吨");
                    if (result == "success")
                    {
        ...
        {
            this.PrintfError("审核过程发生错误，操作失败，请重试");
            return;
        }
    }
    #endregion
    ...
    protected void btnFangkaiPDD_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            this.PrintfError("放开已盘单时出现错误，请重试");
            return;
        }
    }
    #endregion
    ...
    private void InitAll()
    {
        try
        {
            ...
            BindText(PDDH);
            this.ListBox3.Items.Clear();
            DataSet ds = PDParam.GetList("YSDH = (select YSDH from WMS_Che_PDD where PDDH = '" + PDDH + "') and DJLX = '抽盘'");
        ...
        {
            this.PrintfError("选择盘点单号后，进行页面初始化时发生了错误");
            return;
        }
    }
    #endregion
    ...
    private void BindText(string PDDH)
    {
        ...
        {
            this.PrintfError("给文本框赋值时发生错误，请重试");
            return;
        }
    }
    #endregion
    ...
    private void InitAllByYSDH()
    {
        try
        {
            ...
            {
                this.ListBox3.Items.Clear();
                DataSet ds = PDParam.GetList("YSDH = '" + YSDH + "' and DJLX = '抽盘'");
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
        ...
        {
            this.PrintfError("选择原始单号后，对页面初始化时出现错误");
            return;
        }
    }
    #endregion
    ...
    protected void btnnext_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            this.PrintfError("跳转到下一条盘点单信息时出现错误");
            return;
        }
    }
    #endregion
    ...
    protected void btnlast_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            this.PrintfError("跳转到上一条盘点单信息时出现错误，请重试");
            return;
        }
    }
    #endregion
