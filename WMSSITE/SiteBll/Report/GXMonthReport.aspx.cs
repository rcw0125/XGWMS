...
public partial class SiteBll_Report_GXMonthReport :AccPageBase
{
    ...
    protected void imgBtnOK_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Common.IsOldData)
        {
            this.ReportView1.ReportPath = "/XGReportO/GXMonth";
        }
        else
            this.ReportView1.ReportPath = "/XGReportC/GXMonth";
        ...
        ReportView1.SetParameter("scxname", strScxName);
    }
}
