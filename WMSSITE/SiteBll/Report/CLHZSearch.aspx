<%@ page language="C#" autoeventwireup="true" CodeFile="CLHZSearch.aspx.cs" inherits="SiteBll_Report_CLHZSearch" %>
...
<body leftmargin="0" topmargin="0" style>
    <form id="form1" runat="server">
     <TABLE class="fixColStyle" id="Table1" height="28" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD vAlign="middle" align="center" width="70%"><font style="FONT-SIZE: 12px; COLOR: #072d52; FONT-FAMILY: 宋体"><asp:literal id="m_labTitle" runat="server" Text="产量汇总数据查询"></asp:literal></font></TD>
					<TD vAlign="middle" align="center" width="2%"><IMG src="../../images/icon/compartcenter.gif" align="textTop">
					</TD>
    ...
    <DIV style="BORDER:0px;PADDING:0px;MARGIN:0px;width:99%;height:420px;overflow:auto;white-space:nowrap;">
                <asp:GridView ID="grvFYDList" runat="server" AutoGenerateColumns="False" 
                    ...
                    OnRowCreated="grvFYDList_RowCreated" OnSorting="grvFYDList_Sorting"  style="min-width:1200px; width:100%; "
                    HorizontalAlign="Right">
                    <Columns>
                        <asp:BoundField DataField="jhddh" HeaderText="计划订单号"  SortExpression="jhddh">
                          <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ph" HeaderText="钢种" SortExpression="ph" >
                          <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
