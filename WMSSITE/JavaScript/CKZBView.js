...
function GetFree1()
{
    var hidRKPCH=document.getElementById("hidFree1");
    var chkRKPCH=document.getElementById("chkFree1");
...
function GetFree2()
{
    var hidRKPCH=document.getElementById("hidFree2");
    var chkRKPCH=document.getElementById("chkFree2");
...
function GetFree3()
{
    var hidRKPCH=document.getElementById("hidFree3");
    var chkRKPCH=document.getElementById("chkFree3");
...
function LoadRKType()
{
    ...
    else
    {
        ...
        var oDoc=getXmlDocument();
        oDoc.loadXML(result);
　　	var items1 = oDoc.selectNodes("//NewDataSet/Table/CKType");
　　	var itemsLength=items1.length; 
　　	if(itemsLength>0)
　　	{
　　	    var varItem = new Option("请选择","请选择");
