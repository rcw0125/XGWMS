...
{
    public class SqlHelp : AdoHelper
    {
        /// <summary>
        ...
        /// <param name="ds"></param>
        /// <returns></returns>
        public void DataSetUpdate(string connectionString, DataSet ds)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables.Count; i++)
                {
                    ...
                    SqlDataAdapter adpt = new SqlDataAdapter("select * from [" + tableName + "] where 1=2", con);
                    adpt.SelectCommand.Transaction = trans;
